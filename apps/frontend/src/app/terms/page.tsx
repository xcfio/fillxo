        ...
        <PageContainer>
            <div className="max-w-4xl mx-auto">
                ...
                <Card className="space-y-8">
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-blue-400">4. Freelancer and Client Obligations</h2>
                    ...
                    <section>
                        ...
                        <p className="text-gray-300 leading-relaxed mb-3">
                            fillxo may charge service fees for using our platform. All fees are subject to change with
                            prior notice.
                        </p>
                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                    ...
                    <section>
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            The platform and its original content, features, and functionality are owned by fillxo and
                    ...
                    <section>
                        ...
                        <p className="text-gray-300 leading-relaxed mb-3">
                            In the event of a dispute between users, fillxo will provide mediation services. However:
                        </p>
                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                    ...
                    <section>
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            fillxo shall not be liable for any indirect, incidental, special, consequential, or punitive
                            damages resulting from your use or inability to use the service. We do not guarantee the
                            quality of work performed by freelancers or the behavior of clients.
                        </p>
                    </section>
