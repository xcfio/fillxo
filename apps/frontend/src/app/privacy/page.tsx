                ...
                <Card className="space-y-8">
                    <section>
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            fillxo ("we", "our", or "us") is committed to protecting your privacy. This Privacy Policy
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                            <li>
                                <strong className="text-white">With other users:</strong> Your profile information is
                                visible to other users to facilitate connections
                            </li>
                            <li>
                                <strong className="text-white">With service providers:</strong> Third-party vendors who
                                perform services on our behalf (payment processing, analytics)
                            </li>
                            <li>
                                <strong className="text-white">For legal reasons:</strong> When required by law or to
                                protect our rights
                            </li>
                            <li>
                    ...
                    <section>
                        ...
                        <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
                            ...
                            <li>
                                <strong className="text-white">Correction:</strong> Update or correct your information
                            </li>
                            <li>
                    ...
                    <section>
                        ...
                        <p className="text-gray-300 leading-relaxed">
                            Your information may be transferred to and processed in countries other than Bangladesh. We
                    ...
                    <section>
                        <h2 className="text-2xl font-bold mb-4 text-blue-400">12. Changes to This Privacy Policy</h2>
                        <p className="text-gray-300 leading-relaxed">
                            ...
                            notify users of changes through email, in-app notifications, or any other means. It is your
                            responsibility to review this Privacy Policy periodically for any changes. Your continued
                            use of the platform after changes are posted constitutes your acceptance of the updated
                            policy.
                        </p>
                    </section>
                    ...
                    <div className="bg-blue-900/30 border border-blue-700/50 rounded-xl p-6 mt-8">
                        <p className="text-gray-300 text-sm leading-relaxed">
                            ...
                            transparency in how we collect, use, and protect your personal information. If you have any
